...
public class SinglePlayerEasy extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(state[check]==0&& gameActive) {
            if (activeplayer == 1) {
                ...
                player2moveindicator.setBackgroundColor(Color.argb(255,54,145,32));
                player1moveindicator.setBackgroundColor(Color.argb(255,222,237,222));
                gameCoordinate.setpoint(check / 3, check % 3);
                gameBoard.placeAMove(gameCoordinate, 2);
                ...
                player2moveindicator.setBackgroundColor(Color.argb(255, 222, 237, 222));
                gameCoordinate.setpoint(check / 3, check % 3);
                gameBoard.placeAMove(gameCoordinate,1);
            }
        }
        ...
        if(!gameActive){
            ...
            exitButton.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    saveStats(playerWins,playerLose,draw);
                    startActivity(new Intent(SinglePlayerEasy.this, OptionScreen.class));
    ...
    private void win(int a,int b,int c){
        ...
        if(state[a]==1){
            ...
            playerWins++;
            player1score.setText(String.valueOf(playerWins));
        }
        else{
            img1=(ImageView) findViewById(id1);
            img2=(ImageView) findViewById(id2);
            ...
            playerLose++;
            player2score.setText(String.valueOf(playerLose));
        }
